! function (i) {
  ...
  if (i(window).width() > 992) {
    ...
    i(window).on("scroll", {
      ...
      /**
       * @description: 根据鼠标向下或者向上滚动，处理#mainNav的显示和隐藏
       * @return: 
       */
      var s = i(window).scrollTop();
      s < this.previousTop ? 
        s > 0 && i("#mainNav").hasClass("is-fixed") ? i("#mainNav").addClass("is-visible") : i("#mainNav").removeClass("is-visible is-fixed") :
        s > this.previousTop && (i("#mainNav").removeClass("is-visible"), s > o && !i("#mainNav").hasClass("is-fixed") && i("#mainNav").addClass("is-fixed")), this.previousTop = s 
    })
  }
}(jQuery);