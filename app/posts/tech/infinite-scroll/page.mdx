export const metadata = {
  title: "无限滚动（infinite scroll）加载的实现",
  date: "2019-09-10",
  tag: ["javascript", "ui"],
  description: "从原理到实现，全面解析无限滚动加载的技术细节与性能优化",
  duration: '30min'
}
...
![javascript-InfiniteScroll-eg2](https://user-images.githubusercontent.com/28384700/69217371-7fd0f280-0ba9-11ea-9460-40babd89ad43.png)

当鼠标往下滚的时候，`el` 就会向上，`heightBelowTop - offsetHeight + borderBottom` 其实就是 `el` 底部到 `container` 的距离，它和 `distance` 含义其实是一样的。

![javascript-InfiniteScroll-eg3](https://user-images.githubusercontent.com/28384700/69217377-83647980-0ba9-11ea-91fc-788e8747bacf.png)
